...
class Ui_CandidateWindow(object):
    ...
    def setupUi(self, CandidateWindow):
        ...
        CandidateWindow.resize(1420, 800)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        CandidateWindow.setWindowIcon(icon)
        ...
        self.pushButton_4.setStyleSheet("*{\n"
                                        ...
                                        "            background: rgb(89, 51, 135)\n"
                                        "        }")
        self.pushButton_4.clicked.connect(lambda: [self.openMainWindow(), CandidateWindow.hide()])
        ...
        self.pushButton_5.setStyleSheet("*{\n"
                                        ...
                                        "            background: rgb(89, 51, 135)\n"
                                        "        }")
        self.pushButton_5.clicked.connect(lambda: [self.openMoreInformationWindow(), CandidateWindow.hide()])
    ...
    def retranslateUi(self, CandidateWindow):
        ...
        CandidateWindow.setWindowTitle(_translate("CandidateWindow", "CandidateWindow"))
        self.label.setText(_translate("CandidateWindow", "Select Resume"))
        self.label_2.setText(_translate("CandidateWindow", "Select Job Description"))
        self.pushButton.setText(_translate("CandidateWindow", "Launch"))
        self.pushButton_2.setText(_translate("CandidateWindow", "Launch"))
        self.label_3.setText(_translate("CandidateWindow", ""))
        self.pushButton_3.setText(_translate("CandidateWindow", "Calculate"))
        self.pushButton_4.setText(_translate("CandidateWindow", "Back"))
        self.pushButton_5.setText(_translate("CandidateWindow", "More Information"))
